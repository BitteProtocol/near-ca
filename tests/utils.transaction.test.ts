...
import { addSignature, buildTxPayload } from "../src/utils/transaction";
...
describe("Transaction Builder Functions", () => {
  it("addSignature", async () => {
    ...
    expect(signature).toEqual(
      `0x02f86b83aa36a780845974e6f084d0aa7af08094deadbeef0000000000000000000000000b00b1e50180c0${vByte}a0ef532579e267c932b959a1adb9e455ac3c5397d0473471c4c3dd5d62fd4d7edea07c195e658c713d601d245311a259115bb91ec87c86acb07c03bd9c1936a6a9e8`
    );
  });
